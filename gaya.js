...
const pesanLanskap = document.getElementById("pesanLanskap");
pesanLanskap.style.display = "block";
pesanLanskap.style.padding = '20px';
pesanLanskap.style.margin = '20px';
